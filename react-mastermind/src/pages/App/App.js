      ...
      <div className="App">
       {this.state.instructions ?
         <Portal>
                ...
                <img src='https://compote.slate.com/images/fb3403a0-6ffc-471a-8568-b0f01fa3bd6b.jpg' alt="color buttons"/>
                </div>
         </Portal>
          : '<h3>Not Displaying the Portal</h3>'
       }
        {/*test render*/}
        <header className='App-header-footer'>R E A C T &nbsp;&nbsp;&nbsp;  M A S T E R M I N D</header>
        <Switch>
        <Route exact path='/' render ={ () =>
          <GamePage className='GamePage-link-margin'
            winTries={winTries}
